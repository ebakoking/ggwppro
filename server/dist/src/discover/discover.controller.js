...
let DiscoverController = class DiscoverController {
    ...
    getFeed(req, gameId, limit = '10') {
        return this.discoverService.getDiscoverFeed(req.user.id, gameId || undefined, parseInt(limit, 10));
    }
};
...
], DiscoverController.prototype, "getFeed", null);
