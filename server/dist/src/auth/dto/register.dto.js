...
__decorate([
    ...
    (0, class_validator_1.MinLength)(3, { message: 'Kullanıcı adı en az 3 karakter olmalı.' }),
    (0, class_validator_1.MaxLength)(20, { message: 'Kullanıcı adı en fazla 20 karakter olmalı.' }),
...
__decorate([
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.MinLength)(8, { message: 'Şifre en az 8 karakter olmalı.' }),
