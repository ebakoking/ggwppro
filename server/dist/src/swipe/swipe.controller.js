...
let SwipeController = class SwipeController {
    ...
    swipe(req, body) {
        return this.swipeService.swipe(req.user.id, body.toId, body.action, body.gameId);
    }
    whoLikedMe(req, gameId) {
...
__decorate([
    (0, common_1.Get)('who-liked-me'),
    __param(0, (0, common_1.Req)()),
    __param(1, (0, common_1.Query)('gameId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, String]),
    __metadata("design:returntype", void 0)
], SwipeController.prototype, "whoLikedMe", null);
